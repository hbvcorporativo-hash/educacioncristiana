...
export const MENSAJES = {
  ...
  ui: {
    ...
    nivel: {
      ...
      pista: '💡 Pista',
      reto: 'Reto en físico',
      evidencia: '📸 Evidencia del equipo (obligatoria)',
      evidenciaAlt: 'evidencia',
      fotoVacia: 'Tomen la foto del reto terminado (obligatoria)',
    ...
    avisos: {
      ...
      fotoFaltante: { t: 'toma la foto de evidencia antes de validar', k: 'mal' },

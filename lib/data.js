...
export const NIVELES = [
  {
    ...
    reto: 'Identificar cuales son las MENTIRAS frente a cada SITUACIÓN. Cada mentira lleva un número al respaldo: júntenlos en el orden en que aparecen y tendrán la contraseña.',
    tarjetas: [
  ...
  },
  {
    ...
    tarjetas: [
      ['QR 1 · Tu amigo publica una foto y recibe 300 likes. Tú recibes 12. ¿Quién vale más?', 'verdad', '→'],
      ['QR 2 · Alguien te dice: "Nunca vas a cambiar". ¿Qué haces con esa frase?', 'verdad', '→'],
      ['QR 3 · Cometiste un error delante de todos. ¿Tu error define quién eres?', 'verdad', '→'],
      ['QR 4 · Completa: "Mi identidad depende de ______".', 'verdad', '→']
    ],
